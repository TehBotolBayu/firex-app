...
const Login = () => {
  ...
  const renderActivationForm = () => {
    return (
      ...
      <form onSubmit={handleActivate} className='flex flex-col w-[500px]'>
        ...
        <button type="submit" className='bg-primary rounded-2xl px-14 py-1 text-white w-[300px] mx-auto mt-10'>Aktivasi</button>
      </form>
      <p className='my-4'>Sudah punya akun? <span onClick={handleRegister} className=' text-primary underline cursor-pointer'>Login</span></p>
      </div>
    )
  }
  ...
  return (
    ...
    <div className='w-[50vw] flex flex-col justify-center items-center '>
      ...
      <p className='my-4'>Aktivasi Akun Petugas Pemadam Kebakaran <span onClick={handleRegister} className=' text-primary underline cursor-pointer'>Disini</span></p>
    </div>
    :
